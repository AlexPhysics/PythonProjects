...
if __name__ == "__main__":    
    ...
    plt.title('Efficiency to duration graph of a rankine cycle during 10 years')
    plt.grid(True)
    plt.savefig("C:/Users/user/Desktop/COURS/UNIVERSITE/Semestre 5/Thermo TD/HeatMachinesCantera/mod4_rankine/Rankine cycle - Industrial heater/Graphs/efficiencyDuring10Years.png")
    plt.show()
    
cycleRankineCogen001()